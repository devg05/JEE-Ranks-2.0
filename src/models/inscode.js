...
const devSchema = new mongoose.Schema(
    ...
    {
        collection: 'inscode',                                // Explicitly specify the collection name
        versionKey: false                                      // so as to remove  "__v"
    }
);

const insData = mongoose.model('insCode', devSchema);       // frndData is just a variable to store the model created but treat it as out main collection
